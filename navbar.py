...
st.set_page_config(
     page_title='SMA NEGERI 1 TORJUN, SAMPANG`s',
     layout='wide',
     page_icon='random',
)
...
def penjadwalan(cr, mr, popsize, max_iter):
    ...
    while best != 1 and generasi <= max_iter: # oke skrang jalankan GA sebanyak max_iter yang diinginkan
        ...
        # eh maaf salah, maksutnya kita hitung, berapa banyak ortu yg boleh kawin silang
        ...
        anak = list() # sekarng buat list untuk nampung hasil kawin silang si ortu
